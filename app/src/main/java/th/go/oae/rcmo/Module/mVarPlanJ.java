...
public class mVarPlanJ {
    ...
    public double TarangMeter;
    public double NueaTeeBor;

    public double RookPla;
    ...
    public double getTarangMeter() {
        return TarangMeter;
    }

    public void setTarangMeter(double tarangMeter) {
        TarangMeter = tarangMeter;
    }

    public double getNueaTeeBor() {
        return NueaTeeBor;
    }

    public void setNueaTeeBor(double nueaTeeBor) {
        NueaTeeBor = nueaTeeBor;
    }

    public double getRookPla() {
        return RookPla;
    }

    public void setRookPla(double rookPla) {
        RookPla = rookPla;
    }
    ...
    public double getKaLoklen() {
        return KaLoklen;
    }

    public void setKaLoklen(double kaLoklen) {
        KaLoklen = kaLoklen;
    }
