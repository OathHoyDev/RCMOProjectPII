...
public class mVarPlanF {
   ...
   // public double KaPan;
    ...
    public double KaiTDaiTangTaeRoem ;
    public double RakaTKai ;
    public double PonPloyDai;
   ...
   // public double KaSiaOkardLongtoon;
    ...
    public void setKaiTDaiTangTaeRoem(double kaiTDaiTangTaeRoem) {
        KaiTDaiTangTaeRoem = kaiTDaiTangTaeRoem;
    }

    /*
    public double getPonPloyDai() {
        return PonPloyDai;
    }

    public void setPonPloyDai(double ponPloyDai) {
